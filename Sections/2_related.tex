...
\sj{Some studies also linked aesthetics of physical spaces to physical activity, like the study by Ball et.al \cite{ball2001perceived}, where through 3.3k self reported surveys, they show that urban aesthetics have a positive effect on the urge of walking. Another one\cite{giles2005increasing} showed through interviews of 1.8k participants that attractiveness of public open spaces impact positively on increased walking. Finally, a large scale study using a crowd sourced interface\footnote{\url{http://scenic.mysociety.org/)}} looked at relationship between `scenic-ness' of a place with land cover and geography. }
\mbox{}\\
