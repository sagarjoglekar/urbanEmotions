...
\begin{table}[htb!]
    ...
    \begin{tabular}{ |c|c|c|c| }
        ...
        \hline
    \end{tabular}
    \caption{\la{Classification of the PlacesNet labels into the four categories.}}
