...
\begin{description}
	...
	\item \textbf{Step 4 Retrieving a realistic beautified scene.} The generated image has a ``synthetic look'' - it does not look realistic. To fix that, we retrieve the image in the set of curated urban scenes most similar to the generated one. \sj{We use the euclidean distance to compute similarity}
